package com.example.amir.foodapp.map;
...
public class MapsActivity extends FragmentActivity implements
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.B_hopistals:
                ...
                Toast.makeText(MapsActivity.this, "Showing Nearby hotel", Toast.LENGTH_SHORT).show();
                break;
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlaceUrl.append("&key=" + "AIzaSyCTH3598YgvmdsV7oWGsVa7HqTu0-vKHrc");
